// <summary>Tile knows its location on the grid, if it is a ship and if it has been shot before
using System;
...
public class Tile
{
    ...
    // <value&returns>the column of the tile in the grid</value&returns>
    public int Column
    {
        get
        {
    ...
    // <summary> Shoot allows a tile to be shot at, and if the tile has been hit before it will give an error
    internal void Shoot()
    {
        if ((false == Shot))
        {
