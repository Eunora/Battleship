...
static class UtilityFunctions
{
    ...
    // return, >true if the mouse is in the area checked</returns>
    ...
    // summary, Draws the message to the screen
	...
	//add explosion animation to the specify cell
	public static void AddExplosion(int row, int col)
	{
		AddAnimation(row, col, "Splash");
	}

	//add splash animation to the specify cell
	...
	//add animation to the specify cell including image
	...
	/*	update all available animation, add animation that has already draw to 
		ended and remove it from _Animations
	*/
	...
	//draw each animation from the variable _Animations
	...
	//while Drawing animation, it also updating the animation 
